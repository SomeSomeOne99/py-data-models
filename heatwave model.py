...
temperature_predictions = sarimaModel.predict(temperature, 24*1)
sarimaModel.train(humidity, 2, 0, 1, 24)
humidity_predictions = sarimaModel.predict(humidity, 24*1)
sarimaModel.train(windspeed, 2, 0, 1, 24)
windspeed_predictions = sarimaModel.predict(windspeed, 24*1)

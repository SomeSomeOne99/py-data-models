...
if __name__ == "__main__":
    ...
    plt.plot(range(len(predictions)), predictions, label='Predictions [2, 0, 0]', linestyle='--')
    plt.plot(range(len(predictions2)), predictions2, label='Predictions [2, 0, 1]', linestyle='dotted')
    plt.plot(range(len(predictions3)), predictions3, label='Predictions [2, 0, 2]', linestyle='-')
